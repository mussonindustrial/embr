...
class IF97ScriptModuleImpl : IF97ScriptModule {
    ...
    override fun isobaricCubicExpansionCoefficient(args: Array<PyObject>, keywords: Array<String>): Double =
        IF97PyArgOverloads.isobaricCubicExpansionCoefficient.call(args, keywords) as Double
    ...
    override fun specificEnthalpySaturatedLiquid(args: Array<PyObject>, keywords: Array<String>): Double =
        IF97PyArgOverloads.specificEnthalpySaturatedLiquid.call(args, keywords) as Double
    ...
    override fun specificEnthalpySaturatedVapor(args: Array<PyObject>, keywords: Array<String>): Double =
        IF97PyArgOverloads.specificEnthalpySaturatedVapor.call(args, keywords) as Double
    ...
    override fun specificEntropySaturatedLiquid(args: Array<PyObject>, keywords: Array<String>): Double =
        IF97PyArgOverloads.specificEntropySaturatedLiquid.call(args, keywords) as Double
    ...
    override fun specificEntropySaturatedVapor(args: Array<PyObject>, keywords: Array<String>): Double =
        IF97PyArgOverloads.specificEntropySaturatedVapor.call(args, keywords) as Double
    ...
    override fun specificInternalEnergySaturatedLiquid(args: Array<PyObject>, keywords: Array<String>): Double =
    ...
    override fun specificInternalEnergySaturatedVapor(args: Array<PyObject>, keywords: Array<String>): Double =
    ...
    override fun specificVolumeSaturatedLiquid(args: Array<PyObject>, keywords: Array<String>): Double =
        IF97PyArgOverloads.specificVolumeSaturatedLiquid.call(args, keywords) as Double
    ...
    override fun specificVolumeSaturatedVapor(args: Array<PyObject>, keywords: Array<String>): Double =
        IF97PyArgOverloads.specificVolumeSaturatedVapor.call(args, keywords) as Double
