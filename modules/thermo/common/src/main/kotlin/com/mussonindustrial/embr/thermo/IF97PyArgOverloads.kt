...
object IF97PyArgOverloads {
    ...
    val saturationPressure =
        PyArgOverloadBuilder()
            ...
            .addOverload({ if97.saturationPressureT(it[0] as Double) }, "t" to typeOf<Double>())
            .addOverload(
    ...
    val saturationTemperature =
        PyArgOverloadBuilder()
            ...
            .addOverload({ if97.saturationTemperatureP(it[0] as Double) }, "p" to typeOf<Double>())
            .addOverload(
    ...
    val surfaceTension =
        PyArgOverloadBuilder()
            ...
            .addOverload({ if97.surfaceTensionP(it[0] as Double) }, "p" to typeOf<Double>())
            .addOverload({ if97.surfaceTensionT(it[0] as Double) }, "t" to typeOf<Double>())
            .build()
