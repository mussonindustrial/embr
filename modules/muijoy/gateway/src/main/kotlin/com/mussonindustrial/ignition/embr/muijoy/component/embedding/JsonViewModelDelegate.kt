...
import com.mussonindustrial.ignition.embr.muijoy.MuiJoyGatewayContext
import com.mussonindustrial.ignition.embr.muijoy.api.ViewJoinMsg
import java.util.*

class JsonViewModelDelegate(component: Component) : ComponentModelDelegate(component) {

    private val context = MuiJoyGatewayContext.instance
