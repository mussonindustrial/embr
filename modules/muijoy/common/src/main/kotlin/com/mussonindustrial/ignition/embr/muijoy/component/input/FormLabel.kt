...
class FormLabel {
    companion object : PerspectiveComponent {
        override val id: String = "embr.muijoy.input.form-label"

        private val VARIANT_BASE = PaletteEntry(this::class.java, id, "base", "Form Label", "")
