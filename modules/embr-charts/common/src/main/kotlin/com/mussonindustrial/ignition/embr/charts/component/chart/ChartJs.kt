...
class ChartJs {
    companion object {
        ...
        private var VARIANT_BAR = PaletteEntry(Components::class.java,
            "chart-js.bar",
            "Bar",
            "A bar chart or bar graph is a chart or graph that presents categorical data with rectangular bars with heights or lengths proportional to the values that they represent. The bars can be plotted vertically or horizontally."
        )
        private var VARIANT_BUBBLE = PaletteEntry(Components::class.java,
            "chart-js.bubble",
            "Bubble",
        ...
        private var VARIANT_BOXPLOT = PaletteEntry(Components::class.java,
            "chart-js.boxplot",
            "Box Plot",
        ...
        private var VARIANT_DOUGHNUT = PaletteEntry(Components::class.java,
            "chart-js.doughnut",
            "Doughnut",
        ...
        private var VARIANT_LINE = PaletteEntry(Components::class.java,
            "chart-js.line",
            "Line",
        ...
        private var VARIANT_PIE = PaletteEntry(Components::class.java,
            "chart-js.pie",
            "Pie",
        ...
        private var VARIANT_POLARAREA = PaletteEntry(Components::class.java,
            "chart-js.polararea",
            "Polar Area",
            "Polar area charts are similar to pie charts, but each segment has the same angle - the radius of the segment differs depending on the value."
        )
        private var VARIANT_RADAR = PaletteEntry(Components::class.java,
            "chart-js.radar",
            "Radar",
            "A radar chart is a graphical method of displaying multivariate data in the form of a two-dimensional chart of three or more quantitative variables represented on axes starting from the same point."
        )
        private var VARIANT_VIOLIN = PaletteEntry(Components::class.java,
            "chart-js.violin",
            "Violin",
