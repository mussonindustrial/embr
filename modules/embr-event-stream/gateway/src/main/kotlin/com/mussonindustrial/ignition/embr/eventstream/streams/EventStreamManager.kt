...
class EventStreamManager(val context: EventStreamGatewayContext) {
    ...
    inner class Session(private val eventStreams: List<EventStream>, val securityContext: SecurityContext, val sessionType: SessionType) : EventSource, SimpleJsonSerializable {
        private val logger = this.getLogger()
