...
class SmoothieChartComponentDelegate extends ComponentStoreDelegate {
  private proxy = new ComponentDelegateJavaScriptProxy<SmoothieChartRef>(this)

  setProxyRef(ref?: SmoothieChartRef) {
  ...
  handleEvent(eventName: string, eventObject: JsObject) {
    ...
    if (eventName == 'data-append') {
      this.proxy.ref?.appendData(eventObject['values'] as ChartSeriesData[])
    }
  }
