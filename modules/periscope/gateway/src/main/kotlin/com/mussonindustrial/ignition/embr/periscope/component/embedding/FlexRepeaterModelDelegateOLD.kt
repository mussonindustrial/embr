...
class FlexRepeaterModelDelegateOLD(component: Component) : ComponentModelDelegate(component) {
    ...
    override fun handleEvent(message: EventFiredMsg) {
        if (message.eventName == ViewJoinMsg.PROTOCOL) {
            ...
            viewLoader
                .findOrStartView(event.resourcePath, event.mountPath, event.birthDate, JsonObject())
