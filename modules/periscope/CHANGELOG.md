...
- Updated dependencies [3444568]
  ...
  - @embr-modules/periscope-web@0.14.5
...
- Updated dependencies [d11ca3b]
  - @embr-modules/periscope-web@0.14.2
...
- 4675d8f: (React Component) Add `React` component. This component allows you to render a Client Resource as a React component.
