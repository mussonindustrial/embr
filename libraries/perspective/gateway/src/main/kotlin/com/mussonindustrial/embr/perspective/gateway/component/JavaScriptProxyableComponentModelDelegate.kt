...
open class JavaScriptProxyableComponentModelDelegate(component: Component) :
    ...
    protected val jsProxy = JavaScriptProxyImpl()

    override fun onStartup() {
        component.mdc { log.tracef("Startup") }
    }

    override fun onShutdown() {
        component.mdc { log.tracef("Shutdown") }
    }
    ...
    inner class JavaScriptProxyImpl : JavaScriptProxy {
        ...
        private fun runJavaScript(
            ...
            fireEvent(MESSAGE_RUN, JavaScriptRunMsg(id, function, args).getPayload())
            return future
        }
                    ...
                    .addOverload(
                        {
                            val function = TypeUtilities.toString(it["function"])!!
                            val args = it["args"] as? PyDictionary
                            runJavaScript(function, args, null)
