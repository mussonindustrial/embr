...
- 7093468: `PyFrame.getComponentModelScriptWrapper`: Recursively search for `self` items in the frame stack. Resolves #582.

## 0.9.2

### Patch Changes

- 36067e1: Introduce `PerspectiveSessionMonitor`.
