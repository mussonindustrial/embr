...
| [embr-event-stream](modules/server-sent-events/README.md) | Provides an API for high-speed streaming of tag changes via SSE (server-sent events). | [![version](https://img.shields.io/github/v/release/mussonindustrial/embr?filter=*event-stream*&label=%20)](modules/server-sent-events/CHANGELOG.md) |
